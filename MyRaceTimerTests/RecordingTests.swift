...
final class RecordingTests: XCTestCase {
    ...
    func testTimestampString() throws {
        let recording = Recording(id: UUID(), plate: "", timestamp: Date(timeIntervalSince1970: 1700000000.12))
    ...
    func testTimestampStringEmpty() throws {
        let recording = Recording(id: UUID(), plate: "", timestamp: Date(timeIntervalSince1970: 0.0))
        let expected = "--:--:--.--"
        let result = recording.timestampString()
        XCTAssertEqual(expected, result)
    }
    ...
    func testDuplicatePlateWithDuplicate() throws {
        let recordings = [
            ...
            Recording(id: UUID(), plate: "123", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "456", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "789", timestamp: Date(timeIntervalSince1970: 1700000000)),
        ]
    ...
    func testDuplicatePlateNoDuplicate() throws {
        let recordings = [
            Recording(id: UUID(), plate: "111", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "222", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "333", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "444", timestamp: Date(timeIntervalSince1970: 1700000000)),
        ]
    ...
    func testDuplicatePlateEmpty() throws {
        let recordings = [
            Recording(id: UUID(), plate: "", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "333", timestamp: Date(timeIntervalSince1970: 1700000000)),
            Recording(id: UUID(), plate: "444", timestamp: Date(timeIntervalSince1970: 1700000000)),
        ]
